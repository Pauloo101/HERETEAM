...
<head>
    ...
    <link rel="shortcut icon" type="image/jpg" href="shortcutlogo.jpg">
    ...
    <div class="wrapper" id="app">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="#" class="brand-link">
                <img src="{{asset('fountainlogo.png')}}" alt="fountain Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                {{-- <li class="nav-item">
                <a href="/manageassignment" class="nav-link">
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; 2018-2019 <a href="https://buzzdroid.bss.design/">Buzzdroid</a>.</strong> All rights reserved.
        </footer>
    </div>
