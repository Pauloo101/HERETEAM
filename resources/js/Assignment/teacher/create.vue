  ...
  <div>
    ...
    <div class="row">
      <div class="col-6">
        ...
        <textarea v-model="question" placeholder="Type question here"  rows="20" cols="70" class="form-control form-control-sm"></textarea>
        <div class="row mt-4">
          <div class="col">
            <b-form-radio
              v-model="selected"
        ...
        <div class="mt-4">
            ...
            <b-tabs content-class="mt-3" align="center">
              <b-tab title="Basic Assignment" active>
                <!-- Assignment CBT -->
            <!-- basic assignment -->
      ...
      <div class="col">
        <div class="card-header bg-secondary">
          <div class="row w-50">
            <label class="ml-1">List of Question(s)</label>
...
export default {
  ...
  methods: {
    ...
    editquestion(index) {
      this.question = this.form.questions[index].question;
      this.optionA = this.form.questions[index].A;
      this.optionB = this.form.questions[index].B;
      this.optionC = this.form.questions[index].C;
      this.optionD = this.form.questions[index].D;
      this.selected = this.form.questions[index].answer;
      this.number = index + 1;
      this.savequestion();
    },
    canceledit() {
    ...
    updatequestion() {
      ...
      this.form.questions[index].question = this.question;
      this.form.questions[index].A = this.optionA;
      this.form.questions[index].B = this.optionB;
      this.form.questions[index].C = this.optionC;
      this.form.questions[index].D = this.optionD;
      this.form.questions[index].answer = this.selected;
